...
DEL_PADDING_RATIO = 0.002  #used for del_black_or_white
...
if __name__ == "__main__":  
    ...
    destinationFolder = "Size and shape normal/"
    ...
    for file_name in filesArray:
        ...
        cv2.imwrite(destinationFolder+file_name_no_extension+".jpeg",fundus1)
